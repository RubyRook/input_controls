import 'package:input_controls/utils/config.dart';
...
class ValidationMsg {
  ...
  String maxLength (String label, Object param) => get({
    LocaleName.en:'The “$label” field cannot exceed $param characters in length.',
    LocaleName.km:'“$label” មិនអាចលើសពី $param តួអក្សរដែលមានប្រវែង។',
  });

  String minLength (String label, Object param) => get({
    LocaleName.en:'The “$label” field must be at least $param characters in length.',
    LocaleName.km:'“$label” ត្រូវតែមានយ៉ាងហោចណាស់ $param តួអក្សរ។',
  });

  String invalid(String label) => get({LocaleName.en:"The “$label” is invalid.",LocaleName.km:"“$label” មិនត្រឹមត្រូវទេ។"});
  String required(String label) => get({LocaleName.en:"Please enter the “$label”.",LocaleName.km:"សូមបញ្ចូល “$label”។"});
  String selectRequired(String label) => get({LocaleName.en:"Please select any “$label”.",LocaleName.km:"សូមជ្រើសរើស “$label” ណាមួយ។"});
  String numeric(String label) => get({LocaleName.en:"The “$label” field must contain only numbers.", LocaleName.km:"“$label” ត្រូវមានតែលេខប៉ុណ្ណោះ។"});
  String invalidBirthYear(String label) => get({LocaleName.en:"The “$label” must be smaller than current year.",LocaleName.km:"“$label” ត្រូវតែតូចជាងឆ្នាំបច្ចុប្បន្ន។"});

  String exactLength(String label, Object param) => get({LocaleName.en:"The “$label” field must be equal $param characters in length.",LocaleName.km:"“$label” ត្រូវតែស្មើ $param តួអក្សរដែលមានប្រវែង។"});
  String lessThan(String label, Object param) => get({LocaleName.en:"The “$label” field must be less than $param.",LocaleName.km:"“$label” ត្រូវតែតិចជាង $param។"});
  String lessThanEqualTo(String label, Object param) => get({LocaleName.en:"The “$label” field must be less than or equal $param.",LocaleName.km:"“$label” ត្រូវតែតិចជាង ឬស្មើ $param។"});
  String greaterThan(String label, Object param) => get({LocaleName.en:"The “$label” field must be greater than $param.",LocaleName.km:"“$label” ត្រូវតែធំជាង $param។"});
  String greaterThanEqualTo(String label, Object param) => get({LocaleName.en:"The “$label” field greater than or equal $param.",LocaleName.km:"“$label” ត្រូវតែធំជាង ឬស្មើ $param។"});

  String get priceGreaterThanEqualTo => get({LocaleName.en:"Please enter the valid price.",LocaleName.km:"សូមបញ្ចូលតម្លៃអោយបានត្រឹមត្រូវ។"});

  String get(Map<LocaleName, String> languages){
    final config = InputConfig.instance;
    if (languages[config.locale] case final result?) return result;
